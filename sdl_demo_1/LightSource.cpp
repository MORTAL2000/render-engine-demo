...
namespace Bagnall
{
	...
	{
		//glUniformMatrix4fv(Game::LightSourcesLoc, NUM_LIGHT_SOURCES, GL_FALSE, lightSourceMatrices);
		//glUniform4fv(Game::LightSourcesLoc, NUM_LIGHT_SOURCES * 16, lightSourceMatrices);
		mat4 lightSource;
	...
	{
		//glUniformMatrix4fv(Game::LightSourcesLoc, index, GL_FALSE, mat4(ambient, diffuse, specular, position));
